...
`,(0,ee.default)(eo.Tv.BodyPrimary).withConfig({displayName:"media__NoContentText",componentId:"sc-da753e94-8"})`
  ...
  color: ${e$.O9.gray500};
`;var eF=n(26030);(r=a||(a={}))[r.Image=0]="Image",r[r.Video=1]="Video",r[r.Audio=2]="Audio",ee.default.div.withConfig({displayName:"icons__StyledMarketplaceContainer",componentId:"sc-10a3df04-0"})`
  position: absolute;
  display: flex;
  top: 12px;
  left: 12px;
...
`,th=({top:e,show:t})=>(0,s.jsx)(ev.n,{marginX:"24",borderWidth:"1px",borderStyle:"solid",borderColor:"transparent",borderTopColor:e?"transparent":"backgroundOutline",borderBottomColor:e?"backgroundOutline":"transparent",opacity:t?"1":"0",transition:"250"});var tf=()=>{let{resetSellAssets:e,sellAssets:t}=(0,ek.Pc)(({reset:e,sellAssets:t})=>({resetSellAssets:e,sellAssets:t}),V.X),{setProfilePageState:n}=(0,ek.aO)(({setProfilePageState:e})=>({setProfilePageState:e})),{bagStatus:i,bagIsLocked:r,reset:o,bagExpanded:a,toggleBag:p,setBagExpanded:x}=(0,ek.cP)(e=>({...e,bagIsLocked:e.isLocked,uncheckedItemsInBag:e.itemsInBag}),V.X),{uncheckedItemsInBag:g}=(0,ek.cP)(({itemsInBag:e})=>({uncheckedItemsInBag:e})),m=(0,u.e5)(),h=(0,u._3)(),f=(0,u.GZ)(),I=(0,ek.dD)(),N=(0,B.useMemo)(()=>(0,H.G7)(g),[g]),[_,C]=(0,B.useState)(!1),{userCanScroll:T,scrollRef:A,scrollProgress:y,scrollHandler:E}=(0,ek.uh)(),w=(0,B.useCallback)(()=>{x({bagExpanded:!1,manualClose:!0})},[x]);(0,B.useEffect)(()=>{r&&!_&&C(!0)},[r,_]);let v=N.length>0,j=N.length>0,b=t.length>0,O=!!(!m&&!j&&i===z.s.ADDING_TO_BAG||m&&!b),k=(0,B.useMemo)(()=>({...(0,H.Hj)(N.map(e=>e.asset))}),[N]);return a&&f?(0,s.jsxs)(ej.h,{children:[(0,s.jsxs)(tx,{"data-testid":"nft-bag",raiseZIndex:I||_,isProfilePage:m,children:[(0,s.jsx)(to,{numberOfAssets:m?t.length:N.length,closeBag:w,resetFlow:m?e:o,isProfilePage:m}),O&&(0,s.jsx)(td,{}),(0,s.jsx)(th,{top:!0,show:T&&y>0}),(0,s.jsx)(eb.sg,{ref:A,className:"_1jcz50r1 rgw6ez2ej rgw6ez2k1 rgw6ez1yv rgw6ez7nf",onScroll:E,gap:"12",children:m?(0,s.jsx)(tc,{}):(0,s.jsx)(e7,{})}),v&&!m&&(0,s.jsx)(ew,{setModalIsOpen:C,eventProperties:k}),b&&m&&(0,s.jsx)(tm,{onClick:()=>{p(),n(z.HA.LISTING),(0,c._P)(l.Yz.NFT_PROFILE_PAGE_START_SELL,{list_quantity:t.length,collection_addresses:t.map(e=>e.asset_contract.address),token_ids:t.map(e=>e.tokenId)})},children:(0,s.jsx)(d.cC,{id:"xGVfLh"})})]}),h?(0,s.jsx)(tg,{onClick:p}):_&&(0,s.jsx)(eO.a,{onClick:()=>r?void 0:C(!1)})]}):null}}}]);
//# sourceMappingURL=618.a6910e2a.chunk.js.map